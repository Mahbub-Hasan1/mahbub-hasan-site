...
const MySomeWorks = () => {
    return (
        <div className="container">
            ...
            <div className="card-deck">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">A Single page web app with admin’s panel, form where an admin can add a service, add an admin, and update orders status to notify the client about their order’s progress. It is a responsive site.
                        </p>
                    </div>
            ...
            <Link to="/projects">
                <h3 className="text-white text-center"><input type="submit" value="See More Projects" style={{ marginLeft: '15px', backgroundColor: "#44DFC4", color: "#111430" }} className="btn btn-primary text-center text-bold" /> </h3>
            </Link>
        </div>
    );
};
